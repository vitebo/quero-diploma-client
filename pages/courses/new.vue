  ...
  data () {
    return {
      ...
      courses: [
        ...
        "Engenharia de Qualidade e Produtividade",
        "Bullying",
        "Análise de Crédito",
        "Apicultura",
        "Equinocultura",
        ...
        "Learn C# with Windows Forms and VS 2017",
        ...
        "Python Stats. Basics",
        "Get Fit: Quick Workouts for Every Day",
        ...
        "Adobe Photoshop Lightroom Classic CC Training",
        "A Crash Course in APIs using AWS",
        "Blockchain and Bitcoins - A Complete Package",
